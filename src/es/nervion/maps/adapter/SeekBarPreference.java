...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private static final String ATRIBUTO1="es.nervion.maps.atributo1";
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        mMaxValue = attrs.getAttributeIntValue(ATRIBUTO1, "max", 1000);
        ...
        mUnitsRight = getAttributeStringValue(attrs, ATRIBUTO2, "unitsRight", units);
        
        try {
            String newInterval = attrs.getAttributeValue(ATRIBUTO2, "interval");
            if(newInterval != null)
    ...
    protected View onCreateView(ViewGroup parent){
        ...
        {
            Log.e(TAG, "Error al crear la seek bar", e);
        }
    ...
    public void onBindView(View view) {
        ...
        try
        {
            ...
            Log.e(TAG, "Error al bindear la vista: " + ex.toString());
        }
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            Log.e(TAG, "Error actualizando el seek bar", e);
        }
    ...
    protected void onSetInitialValue(boolean restoreValue, Object defaultValue) {
        ...
        if(restoreValue) {
            ...
            try {
                ...
                Log.e(TAG, "Error añadiendo valor por defecto: " + defaultValue.toString());
            }
